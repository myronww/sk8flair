...
export TARGETHOST=sk8s-erniekirkland-r.local

echo "Deploying to target host ($TARGETHOST)"

ssh-keygen -R sk8s-erniekirkland-r.local 
...
scp ./bluetooth/erniekirkland-right.conf root@$TARGETHOST:/etc/bluetooth/main.conf
