...
export TARGETHOST=sk8s-daronwalker-l.local

echo "Deploying to target host ($TARGETHOST)"

ssh-keygen -R sk8s-daronwalker-l.local 
...
scp ./bluetooth/daronwalker-left.conf root@$TARGETHOST:/etc/bluetooth/main.conf
