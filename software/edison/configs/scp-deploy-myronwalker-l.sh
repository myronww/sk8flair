...
export TARGETHOST=sk8s-myronwalker-l.local

echo "Deploying to target host ($TARGETHOST)"

ssh-keygen -R sk8s-myronwalker-l.local 
...
scp ./bluetooth/myronwalker-left.conf root@$TARGETHOST:/etc/bluetooth/main.conf
