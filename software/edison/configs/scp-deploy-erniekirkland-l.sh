...
export TARGETHOST=sk8s-erniekirkland-l.local

echo "Deploying to target host ($TARGETHOST)"

ssh-keygen -R sk8s-erniekirkland-l.local 
...
scp ./bluetooth/erniekirkland-left.conf root@$TARGETHOST:/etc/bluetooth/main.conf
